  ...
  const mintNFT = async (_slotID) => {
    try {
      ...
      let contractAddress = "0x0c60447Ce83877C19c52B8E876D194D00f68b30e";
        ...
        let Tx = await BBCCContract.mintSuperCar(_slotID, {value: ethers.utils.parseEther("0.1")});
        console.log("tx mintied");
        Tx.wait();
        console.log(Tx);
    } catch (error) {}
  };
    ...
    <>
      <div id='herosection' className='hero-container'>
        ...
        <div className='containerBox'>
          <h1 className='tokenminted1'>Tokens Minted : <span style={{ color: '#2C9B1A' }}>&nbsp;{ts}</span>/8000</h1>
        ...
        <div className='mintButton'>
          <Button className='mint' onClick={() =>mintNFT(slotvalue)}>Mint Now</Button>
        </div>
          ...
          <Grid container spacing={0}>
            <Grid item xs={4} md={4} sm={4}>
              <div className='imgBox'>
                <a ><img className='img-footer' src={Discord} /></a>
              </div>
            </Grid>
            <Grid item xs={4} md={4} sm={4}>
              <div className='imgBox'>
                <a ><img className='img-footer' src={Instagram} /></a>
              </div>
            </Grid>
            <Grid item xs={4} md={4} sm={4}>
              <div className='imgBox'>
                <a><img className='img-footer' src={Twitter} /></a>
              </div>
            </Grid>
          </Grid>
        </div>
